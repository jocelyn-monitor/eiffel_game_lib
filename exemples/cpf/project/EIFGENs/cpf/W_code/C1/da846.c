...
extern EIF_TYPED_VALUE F846_7574(EIF_REFERENCE);
extern EIF_TYPED_VALUE F846_7575(EIF_REFERENCE);
extern EIF_TYPED_VALUE F846_7576(EIF_REFERENCE);
extern EIF_TYPED_VALUE F846_7577(EIF_REFERENCE);
extern EIF_TYPED_VALUE F846_7578(EIF_REFERENCE);
extern EIF_TYPED_VALUE F846_7579(EIF_REFERENCE);
extern EIF_TYPED_VALUE F846_7580(EIF_REFERENCE);
extern EIF_TYPED_VALUE F846_7581(EIF_REFERENCE);
...
EIF_TYPED_VALUE F846_7574 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F846_7574,12779,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F846_7575)
EIF_TYPED_VALUE F846_7575 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 845, Current, 0, 0, 12779);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(845, Current, 12779);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {845,219,201,0xFFFF};
		EIF_TYPE_INDEX typres0;
		static EIF_TYPE_INDEX typcache0 = INVALID_DTYPE;
		
		typres0 = (typcache0 != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(Dftype(Current), 219, typarr0)));
	...
	*((EIF_REFERENCE *)tr2+6) = (EIF_REFERENCE) tr3;
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVPF(75, 5, "compare_objects", Result))(Result);
	RTVI(Current, RTAL);
	RTRS;
	RTOTE;
	RTHOOK(3);
...
RTOID (F846_7576)
EIF_TYPED_VALUE F846_7576 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 845, Current, 0, 0, 12780);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(845, Current, 12780);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000E7, 0,0); /* Result */
...
RTOID (F846_7577)
EIF_TYPED_VALUE F846_7577 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 845, Current, 0, 0, 12781);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(845, Current, 12781);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000E7, 0,0); /* Result */
...
RTOID (F846_7578)
EIF_TYPED_VALUE F846_7578 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 845, Current, 0, 0, 12782);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(845, Current, 12782);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000E7, 0,0); /* Result */
...
EIF_TYPED_VALUE F846_7579 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F846_7579,12784,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F846_7580 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F846_7580,12785,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F846_7581 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F846_7581,12786,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit846 (void)
{
	GTCX
	RTOTS (7574,F846_7574)
	RTOTS (7575,F846_7575)
	RTOTS (7576,F846_7576)
	RTOTS (7577,F846_7577)
	RTOTS (7578,F846_7578)
	RTOTS (7579,F846_7579)
	RTOTS (7580,F846_7580)
	RTOTS (7581,F846_7581)
}
